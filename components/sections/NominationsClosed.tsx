        ...
        <div className="text-center animate-fade-in relative z-10">
          <div className="inline-block">
            ...
            <div className="mb-4 animate-slide-down">
              <span className="inline-block px-4 py-1 bg-green-600/10 dark:bg-green-400/10 border border-green-600/30 rounded-full text-sm font-medium text-green-700 dark:text-green-300">
                2026 Awards
              </span>
            </div>

            {/* Main text */}
            <h2 className="text-5xl md:text-7xl font-bold text-green-800 dark:text-green-100 mb-6 animate-slide-up">
              Nominations
              <br />
            ...
            {/* Subtitle */}
            <p className="text-lg text-green-700 dark:text-green-300 animate-fade-in-delayed">
...
export default NominationsClosed;
